...
class ViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.rangeSlider.thumbType = 0              // e.g. number of corners:  0 = circle , 3 = triangle, 4 = square
        self.rangeSlider.curvaceousness = 1.0       // 0.0 - 1.0   only applies to the circle and the track   0 -> square
        self.rangeSlider.trackSizeScale = 0.3       // e.g. 0.2 to get a thinner track while maintaining normal size thumbs
        
        self.rangeSlider.trackTintColor = UIColor.gray
        self.rangeSlider.trackHighlightTintColor = UIColor.red
        self.rangeSlider.thumbLineWidth = 1.5
        self.rangeSlider.thumbStrokeColor = UIColor.white
